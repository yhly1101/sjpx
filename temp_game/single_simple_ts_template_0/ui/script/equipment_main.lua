...
base.i18n.load_map("single_simple_ts_template_0_nx8b")
---scene_folder---
...
local ret = {["single_simple_ts_template_0_nx8b"] = single_simple_ts_template_0_nx8b}
for k, v in pairs(____module or {}) do ret["single_simple_ts_template_0_nx8b"][k] = v end
